from gym import Env
from CybORG.Agents.Wrappers import BaseWrapper, OpenAIGymWrapper, RedTableWrapper, EnumActionWrapper, PettingZooParallelWrapper

# corrected BlueTableWrapper
from .BlueTableWrapper import BlueTableWrapper


class ChallengeWrapper3(Env, BaseWrapper):
    def __init__(self, agent_name: str, env, agent=None,
        ...
        #env = table_wrapper(env)
        #self.action_space = env.get_action_space('blue_agent_0')
        #env = EnumActionWrapper(env)
        
        #self.action_space_len = env.get_action_space('blue_agent_0')
        #print(self.action_space)
        #print(self.action_space_len)
        self.action_space_dict = self.env.get_action_space('blue_agent_0')
        #print(self.action_space_dict)
        env = OpenAIGymWrapper(agent_name=agent_name, env=env)

        self.env = env
        self.action_space = self.env.action_space
        print(self.action_space)
        self.action_space_len = self.env.action_space_change(self.action_space_dict)
